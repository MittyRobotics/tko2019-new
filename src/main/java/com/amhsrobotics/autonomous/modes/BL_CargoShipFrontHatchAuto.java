...
public class BL_CargoShipFrontHatchAuto extends CommandGroup {
	...
	public BL_CargoShipFrontHatchAuto(int stage){
...
//			visionPickup();
	...
	public void approachCargoShip(){
		...
		addSequential( new Translate2dTrajectory(AutoPaths.B_LEFT_START_TO_FRONT_CS,true));
	...
	public void driveToHelperPoint1(){
		...
		addSequential( new Translate2dTrajectory(AutoPaths.B_LEFT_FRONT_CS_TO_RIGHT_HELPER,true));
	...
	public void approachLoader(){
		...
		addSequential( new Translate2dTrajectory(AutoPaths.B_LEFT_HELPER_TO_RIGHT_LOADER,true));
