...
public class AutoPaths {
	...
	public static PathProperties B_RIGHT_FRONT_CS_TO_LEFT_HELPER = new PathProperties(new Waypoint[]{AutoConstants.BLUE_RIGHT_FRONT_HATCH_REVERSED, AutoConstants.BLUE_RIGHT_HELPER_POINT}, 15, .8, 50, 50, 200,0,0,false,false, "B_RIGHT_FRONT_CS_TO_LEFT_HELPER");
	public static PathProperties B_RIGHT_HELPER_TO_LEFT_LOADER = new PathProperties(new Waypoint[]{AutoConstants.BLUE_RIGHT_HELPER_POINT_TURN, AutoConstants.BLUE_RIGHT_LOADER_STATION}, 15, .8, 50, 50, 200,0,0,true,false, "B_RIGHT_HELPER_TO_LEFT_LOADER");
