...
public class AutoPaths {
	...
	public static PathProperties B_RIGHT_START_TO_END_HAB = new PathProperties(new Waypoint[]{AutoConstants.BLUE_RIGHT_START_POS, new Waypoint(new Point2D.Double(AutoConstants.BLUE_RIGHT_START_POS.getWaypoint().getX() + 50, AutoConstants.BLUE_RIGHT_START_POS.getWaypoint().getY()),0)}, 15, .8, 20, 20, 200,0,0,true,false, "B_RIGHT_START_TO_END_HAB");
	public static PathProperties B_RIGHT_END_HAB_TO_FRONT_CS = new PathProperties(new Waypoint[]{new Waypoint(new Point2D.Double(AutoConstants.BLUE_RIGHT_START_POS.getWaypoint().getX() + 50, AutoConstants.BLUE_RIGHT_START_POS.getWaypoint().getY()),0), AutoConstants.BLUE_RIGHT_FRONT_HATCH}, 15, .8, 10, 10, 200,50,0,true,true, "B_RIGHT_END_HAB_TO_FRONT_CS");
	public static PathProperties B_RIGHT_FRONT_CS_TO_LEFT_HELPER = new PathProperties(new Waypoint[]{AutoConstants.BLUE_RIGHT_FRONT_HATCH_REVERSED, AutoConstants.BLUE_LEFT_HELPER_POINT}, 15, .8, 10, 10, 50,0,0,false,false, "B_RIGHT_FRONT_CS_TO_LEFT_HELPER");
	public static PathProperties B_RIGHT_HELPER_TO_LEFT_LOADER = new PathProperties(new Waypoint[]{AutoConstants.BLUE_LEFT_HELPER_POINT_REVERSED, AutoConstants.BLUE_LEFT_LOADER_STATION}, 15, .8, 10, 10, 50,0,0,true,true, "B_RIGHT_HELPER_TO_LEFT_LOADER");
