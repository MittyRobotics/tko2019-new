...
public class AutoPaths {
	...
	public static PathProperties B_RIGHT_FRONT_CS_TO_RIGHT_HELPER = new PathProperties(new Waypoint[]{AutoConstants.BLUE_RIGHT_FRONT_HATCH_REVERSED, AutoConstants.BLUE_RIGHT_HELPER_POINT}, 20, .8, 100, 50, 150,50,0,false,false, "B_RIGHT_FRONT_CS_TO_RIGHT_HELPER");
