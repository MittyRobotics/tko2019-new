...
public class AutoConstants {
	...
	//Loader
	public static Waypoint BLUE_RIGHT_LOADER_STATION = new Waypoint(new Point2D.Double(ROBOT_CENTER_TO_BACK, BLUE_RIGHT_FIELD_EDGE_TO_LOADER_CENTER), 0);
	public static Waypoint BLUE_LEFT_LOADER_STATION = new Waypoint(new Point2D.Double(ROBOT_CENTER_TO_BACK, FIELD_HEIGHT - BLUE_LEFT_FIELD_EDGE_TO_LOADER_CENTER), 0);

	//Rocket Hatch
	public static Waypoint BLUE_RIGHT_ROCKET_HATCH = new Waypoint(new Point2D.Double((BLUE_RIGHT_FIELD_BACK_TO_ROCKET_HATCH_CENTER)  - (Math.cos(Math.toRadians(28.75) )* ROBOT_CENTER_TO_BACK)  ,(BLUE_RIGHT_ROCKET_EXTRUSION + ROCKET_HATCH_CENTER_TO_OUTER_EDGE) + (Math.sin(Math.toRadians(28.75) )* ROBOT_CENTER_TO_BACK)) , -21.75);
	public static Waypoint BLUE_LEFT_ROCKET_HATCH = new Waypoint(new Point2D.Double((BLUE_LEFT_FIELD_BACK_TO_ROCKET_HATCH_CENTER)   - (Math.cos(Math.toRadians(28.75) )* ROBOT_CENTER_TO_BACK)  ,FIELD_HEIGHT - ((BLUE_LEFT_ROCKET_EXTRUSION + ROCKET_HATCH_CENTER_TO_OUTER_EDGE) + (Math.sin(Math.toRadians(28.75) )* ROBOT_CENTER_TO_BACK))) , 21.75);
	...
	//Loader
	public static Waypoint BLUE_RIGHT_LOADER_STATION_STANDARD = new Waypoint(new Point2D.Double(0, BLUE_RIGHT_FIELD_EDGE_TO_LOADER_CENTER), 21.75);
	public static Waypoint BLUE_LEFT_LOADER_STATION_STANDARD = new Waypoint(new Point2D.Double(0, FIELD_HEIGHT - BLUE_LEFT_FIELD_EDGE_TO_LOADER_CENTER), -21.75);

	//Rocket Hatch
	public static Waypoint BLUE_RIGHT_ROCKET_HATCH_STANDARD = new Waypoint(new Point2D.Double(BLUE_RIGHT_FIELD_BACK_TO_ROCKET_HATCH_CENTER, BLUE_RIGHT_ROCKET_EXTRUSION + ROCKET_HATCH_CENTER_TO_OUTER_EDGE), 21.75);
	public static Waypoint BLUE_LEFT_ROCKET_HATCH_STANDARD = new Waypoint(new Point2D.Double(BLUE_LEFT_FIELD_BACK_TO_ROCKET_HATCH_CENTER, FIELD_HEIGHT - (BLUE_LEFT_ROCKET_EXTRUSION + ROCKET_HATCH_CENTER_TO_OUTER_EDGE)), -21.75);
	...
	//Loader
	public static Waypoint RED_RIGHT_LOADER_STATION = new Waypoint(new Point2D.Double(ROBOT_CENTER_TO_BACK, RED_RIGHT_FIELD_EDGE_TO_LOADER_CENTER), 0);
	public static Waypoint RED_LEFT_LOADER_STATION = new Waypoint(new Point2D.Double(ROBOT_CENTER_TO_BACK, FIELD_HEIGHT - RED_LEFT_FIELD_EDGE_TO_LOADER_CENTER), 0);

	//Rocket Hatch
	public static Waypoint RED_RIGHT_ROCKET_HATCH = new Waypoint(new Point2D.Double((RED_RIGHT_FIELD_BACK_TO_ROCKET_HATCH_CENTER)  - (Math.cos(Math.toRadians(28.75) )* ROBOT_CENTER_TO_BACK)  ,(RED_RIGHT_ROCKET_EXTRUSION + ROCKET_HATCH_CENTER_TO_OUTER_EDGE) + (Math.sin(Math.toRadians(28.75) )* ROBOT_CENTER_TO_BACK)) , 21.75);
	public static Waypoint RED_LEFT_ROCKET_HATCH = new Waypoint(new Point2D.Double((RED_LEFT_FIELD_BACK_TO_ROCKET_HATCH_CENTER)   - (Math.cos(Math.toRadians(28.75) )* ROBOT_CENTER_TO_BACK)  ,FIELD_HEIGHT - ((RED_LEFT_ROCKET_EXTRUSION + ROCKET_HATCH_CENTER_TO_OUTER_EDGE) + (Math.sin(Math.toRadians(28.75) )* ROBOT_CENTER_TO_BACK))) , -21.75);

	//Helper points
	public static Waypoint RED_RIGHT_HELPER_POINT = new Waypoint(new Point2D.Double(RED_HELPER_DISTANCE_FROM_LOADER, RED_RIGHT_LOADER_STATION.getWaypoint().getY()), 21.75);
	public static Waypoint RED_LEFT_HELPER_POINT = new Waypoint(new Point2D.Double(RED_HELPER_DISTANCE_FROM_LOADER, RED_LEFT_LOADER_STATION.getWaypoint().getY()), -21.75);
	...
	//Rocket Hatch
	public static Waypoint RED_RIGHT_ROCKET_HATCH_STANDARD = new Waypoint(new Point2D.Double(RED_RIGHT_FIELD_BACK_TO_ROCKET_HATCH_CENTER, RED_RIGHT_ROCKET_EXTRUSION + ROCKET_HATCH_CENTER_TO_OUTER_EDGE), 21.75);
	public static Waypoint RED_LEFT_ROCKET_HATCH_STANDARD = new Waypoint(new Point2D.Double(RED_LEFT_FIELD_BACK_TO_ROCKET_HATCH_CENTER, FIELD_HEIGHT - (RED_LEFT_ROCKET_EXTRUSION + ROCKET_HATCH_CENTER_TO_OUTER_EDGE)), -21.75);
