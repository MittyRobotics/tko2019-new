...
public class AutoConstants {
	...
	public static Waypoint BLUE_LEFT_LOADER_STATION = new Waypoint(new Point2D.Double(ROBOT_CENTER_TO_BACK, FIELD_HEIGHT - BLUE_LEFT_FIELD_EDGE_TO_LOADER_CENTER-BLUE_TUNING_SHIFT_LOADER-BLUE_TUNING_SHIFT_LOADER), 180);
