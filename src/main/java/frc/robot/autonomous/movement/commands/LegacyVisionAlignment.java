 ...
 */
public class LegacyVisionAlignment extends Command {
	...
	/**
	 * Initializes command with a name "LegacyVisionAlignment" and the required subsystem class that will be used, {@link DriveTrain}
	 */
	public LegacyVisionAlignment() {
		super("LegacyVisionAlignment");
	...
	public void end() {
		...
		System.out.println("Ended LegacyVisionAlignment.java command");
	}
